<template>
  <div class="shymkentIntroContainer">
    ...
    >
      <img
        class="fit"
        src="https://cache.marriott.com/content/dam/marriott-renditions/TSERZ/tserz-attraction-skyline-0030-hor-wide.jpg?output-quality=70&interpolation=progressive-bilinear&downsize=2880px:*"
        alt=""
      />
      <p
